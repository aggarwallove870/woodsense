...
# from pages.models import CustomPage, HomePage, GalleryPage, GalleryImage, OnSalePage, TourPage, ReviewsPage, Review, AboutPage, ContactPage
...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        from pages.models import GalleryImage,HomePage,TourPage,Review
...
class GalleryListView(ListView):
    ...
    def get_queryset(self):
        return pages.models.GalleryImage.objects.all()

    def get_context_data(self, *args, **kwargs):
        from pages.models import GalleryPage
...
class OnSaleListView(ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        from pages.models import OnSalePage
        ctx = super().get_context_data(*args, **kwargs)
...
#     def get_queryset(self):
#         return pages.models.TourPage.objects.all()
...
class CustomPageDetailView(DetailView):
    ...
    def get_queryset(self):
        return pages.models.CustomPage.objects.all()
...
class ReviewsListView(ListView):
    ...
    def get_queryset(self):
        return pages.models.Review.objects.all()

    def get_context_data(self, **kwargs):
        ctx = super().get_context_data(**kwargs)
        ctx['solo'] = pages.models.ReviewsPage.get_solo()
        return ctx
...
class AboutDetailView(DetailView):
    ...
    def get_queryset(self):
        return pages.models.AboutPage.objects.all()
...
class ContactDetailView(FormView):
    ...
    def get_context_data(self, **kwargs):
        ctx = super().get_context_data(**kwargs)
        ctx['page'] = pages.models.ContactPage.get_solo()
        return ctx
