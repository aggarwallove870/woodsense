...
from core.mixins import SEOModelMixin
from core.helpers import unique_slugify, upload_common_images_to, upload_product_images_to, upload_gallery_images_to
...
class Product(SEOModelMixin):
    ...
    categories = TreeManyToManyField('core.Category', related_name='products')
...
class ProductImage(models.Model):
    product = models.ForeignKey('core.Product', on_delete=models.CASCADE, related_name='images')
...
class AbstractFooterColumnItem(models.Model):
    ...
    url = models.CharField(max_length=300, blank=True, verbose_name='Or URL')
    order = models.PositiveIntegerField(default=0, blank=False, null=False)
    footer = models.ForeignKey('core.Footer', on_delete=models.CASCADE)
