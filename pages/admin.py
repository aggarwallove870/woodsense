...
from pages.models import Page, CustomPage, HomePage, HomeBanner, GalleryImage, GalleryPage, OnSalePage, TourPage,\
...
class GalleryPageAdmin(SingletonModelAdmin,SortableAdminBase):
